...
return [
    ...
    'custom'               => [
        'slug' => [
            'regex' => 'Неправильный формат URL страницы! Можно использовать только латинские символы, цифры и дефис.',
        ],
    ],
    ...
    'attributes' => [
        ...
        'slug' => 'URL страницы',
        'sub_category' => 'Группа материала',
        'title' => 'Title материала',
        'h1' => ' H1 материала',
        'description' => 'Description материала',
        'name' => 'Имя',
        'email' => 'Email',
        'subject' => 'Тема',
        'message' => 'Сообщение',
